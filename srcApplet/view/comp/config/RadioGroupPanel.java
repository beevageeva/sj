...
public class RadioGroupPanel extends JPanel{
	...
	public RadioGroupPanel(String label,String[] labels , short[] values,int selectedValue){
		this(label, labels, values , selectedValue, false);
	}
	...
	public void addActionListener(int buttonValue , ActionListener al ){
